...
images:
  [
    '/static/images/Eine_Empfehlungsmaschine_mithilfe_der_OpenAI_GPT-4_API_entwickeln_1727307340_main.png',
  ]
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Grundlagen der
  Empfehlungsmaschine](/static/images/Grundlagen_der_Empfehlungsmaschine_1727306963_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  GPT-4](/static/images/Entwicklung_einer_Empfehlungsmaschine_mit_OpenAI_GPT-4_1727307158_16-9.png)
</div>
