...
draft: false
images: ['/static/images/Maschinelles_Lernen_in_Ihre_Webanwendungen_mit_APIs_integrieren_1727299599_main.png']
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Grundlagen des maschinellen Lernens](/static/images/Grundlagen_des_maschinellen_Lernens_1727299086_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Integration von APIs in Webanwendungen](/static/images/Integration_von_APIs_in_Webanwendungen_1727299206_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![APIs für das maschinelle Lernen](/static/images/APIs_für_das_maschinelle_Lernen_1727299333_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Beispiele für die Anwendung von ML APIs](/static/images/Beispiele_für_die_Anwendung_von_ML_APIs_1727299450_16-9.png)
</div>
