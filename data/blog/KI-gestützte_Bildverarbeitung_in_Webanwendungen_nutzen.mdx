...
draft: false
images: ['/static/images/KI-gestützte_Bildverarbeitung_in_Webanwendungen_nutzen_1727295277_main.png']
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Grundlagen der KI-gestützten Bildverarbeitung](/static/images/Grundlagen_der_KI-gestützten_Bildverarbeitung_1727294941_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Betrachtung ethischer und rechtlicher Aspekte](/static/images/Betrachtung_ethischer_und_rechtlicher_Aspekte_1727295142_16-9.png)
</div>
