...
draft: false
images: ['/static/images/Best_Practices_zur_Sicherung_Ihrer_Anwendung_bei_der_Verwendung_von_KI-APIs_1727291102_main.png']
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Grundlagen der KI-API-Sicherheit](/static/images/Grundlagen_der_KI-API-Sicherheit_1727290743_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Best Practices für die Sicherung von KI-APIs](/static/images/Best_Practices_für_die_Sicherung_von_KI-APIs_1727290847_16-9.png)
</div>
