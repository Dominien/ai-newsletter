...
draft: false
images: ['/static/images/KI_zur_automatisierten_Testung_in_Webentwicklungsprojekten_nutzen_1727298866_main.png']
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Grundlagen der automatisierten Testung](/static/images/Grundlagen_der_automatisierten_Testung_1727298408_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Einsatz von KI in der automatisierten Testung](/static/images/Einsatz_von_KI_in_der_automatisierten_Testung_1727298533_16-9.png)
</div>
