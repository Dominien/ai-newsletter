...
images:
  [
    '/static/images/ChatGPT_als_Code-Review-Assistenten:_Die_Codequalität_mit_KI_verbessern_1727302223_main.png',
  ]
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  Code-Review](/static/images/Praktische_Anwendung_von_ChatGPT_in_der_Code-Review_1727301980_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  Lösungen](/static/images/Herausforderungen_und_Lösungen_1727302089_16-9.png)
</div>
