...
images:
  [
    '/static/images/Benutzerdefinierte_Modelle_mithilfe_von_Daten_aus_Ihren_Webanwendungen_mit_APIs_trainieren_1727305073_main.png',
  ]
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  extrahieren](/static/images/Daten_aus_Webanwendungen_extrahieren_1727304746_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  erstellen](/static/images/Benutzerdefinierte_Modelle_erstellen_1727304849_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Modelle in Webanwendungen
  integrieren](/static/images/Modelle_in_Webanwendungen_integrieren_1727304942_16-9.png)
</div>
