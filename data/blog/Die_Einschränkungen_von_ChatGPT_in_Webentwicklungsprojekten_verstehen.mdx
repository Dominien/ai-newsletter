...
images:
  [
    '/static/images/Die_Einschränkungen_von_ChatGPT_in_Webentwicklungsprojekten_verstehen_1727294146_main.png',
  ]
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ...
  Webentwicklungsprojekte](/static/images/Auswirkungen_der_Einschränkungen_auf_Webentwicklungsprojekte_1727293882_16-9.png)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
  ![Mögliche Lösungen und
  Alternativen](/static/images/Mögliche_Lösungen_und_Alternativen_1727293996_16-9.png)
</div>
